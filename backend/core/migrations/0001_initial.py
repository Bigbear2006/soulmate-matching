    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('match_type', models.CharField(choices=[('my_city', 'Мой город'), ('other_city', 'Другой регион')], max_length=20)),
                ('workday_type', models.CharField(choices=[('office', 'В офисе (люблю деловой ритм и личные встречи)'), ('branch', 'В отделении (я там, где наши клиенты)'), ('remote', 'На удаленке (люблю работать из дома)')], max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('career_focus_direction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profiles', to='core.careerfocusdirection')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profiles', to='core.city')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profiles', to='core.department')),
                ('interest', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profiles', to='core.interest')),
            ],
            options={
                'verbose_name': 'Анкета',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users', to='core.answer')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='core.profile')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lifestyle', models.CharField(choices=[('talk', 'Мне важно выговориться'), ('distract', 'Мне важно отвлечься от своих мыслей, разделив переживания другого'), ('physical', 'Мне важно физически переключиться')], max_length=20)),
        ...
        migrations.RunPython(fill_reference_data, migrations.RunPython.noop),
    ]

# Generated by Django 6.0.2 on 2026-02-13 16:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career_focus', models.CharField(blank=True, choices=[('result', 'Результат'), ('development', 'Развитие'), ('enjoyment', 'Удовольствие')], max_length=20, verbose_name='Базовое направление')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True, verbose_name='Название')),
                ('territory', models.CharField(blank=True, choices=[('energy', 'Территория Энергии'), ('lampovo', 'Территория Ламповости'), ('hedonism', 'Территория Гедонизма'), ('meaning', 'Территория Смысла'), ('family', 'Родственная территория')], max_length=20, verbose_name='Территория')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ProfileCareerFocusDirection',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='career_focus_directions', to='core.profile', verbose_name='Профиль')),
            ],
            options={
